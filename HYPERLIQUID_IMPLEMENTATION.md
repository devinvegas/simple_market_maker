...
primary_data_feed: Binance     # Optional: Choices: ["Binance", "Bybit", "Hyperliquid"] - Additional market data feed
...
The system supports multiple optional data feeds:

- **Bybit (primary) + Binance (feed)**: Use Binance market data for additional signals
- **Bybit (primary) + Hyperliquid (feed)**: Use Hyperliquid market data for additional signals
- **Hyperliquid (primary) + Binance (feed)**: Use Binance market data for additional signals
- **Hyperliquid (primary) + Bybit (feed)**: Use Bybit market data for additional signals
- **Exchange only**: Use only the primary exchange data
...
3. Optionally set `primary_data_feed: Binance` or `primary_data_feed: Bybit` to use additional data source
